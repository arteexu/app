    ...
    <div className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="glass bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 p-8 flex flex-col gap-4 shadow-sm bitcoin:shadow-[0_0_50px_-10px_rgba(247,147,26,0.1)]">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100 bitcoin:font-display bitcoin:text-white">Create account</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="name" className="text-sm font-medium text-gray-700 dark:text-slate-300 bitcoin:font-mono bitcoin:text-xs bitcoin:uppercase bitcoin:tracking-wider bitcoin:text-[#94A3B8]">Name</label>
              <input
                id="name"
                type="text"
                value={name}
          ...
          <p className="text-sm text-center text-gray-500 dark:text-slate-400 bitcoin:text-[#94A3B8]">
            ...
            <Link href="/signin" className="text-indigo-600 hover:underline font-medium bitcoin:text-[#F7931A] bitcoin:hover:text-[#FFD600]">
              Sign in
            </Link>
          </p>
        </div>
